...
var Wing3D = /** @class */ (function () {
    //flag: 0--线 1--面
    function Wing3D(size, z, frag, flag, edgeColor) {
        var _a;
    ...
    Wing3D.prototype.setCenterColor = function (color) {
...
var ButterFly = /** @class */ (function () {
    function ButterFly() {
        ...
        this.wings = [
            new Wing3D(0.9),
            new Wing3D(0.85, 0.002, 32, 0, '0x1e90ff'),
            new Wing3D(0.85, -0.002, 32, 0, '0x1e90ff'),
            new Wing3D(0.5, 0.004, 200, 1),
            new Wing3D(0.5, -0.004, 200, 1)
        ];
        ...
        for (var _i = 0, LinesOnWings_1 = LinesOnWings; _i < LinesOnWings_1.length; _i++) {
            ...
            var centerPoint = this.wings[j].vertices.slice(0, 2).concat([
                this.wings[j].vertices[2] * 1.5
            ]);
            for (var i = 0; i < this.wings[j].vertices.length; i += 3) {
                (_a = this.lines).push.apply(_a, centerPoint);
                (_b = this.lines).push.apply(_b, this.wings[j].vertices.slice(i, i + 2).concat([centerPoint[2]]));
            }
        }
    ...
    ButterFly.prototype.rotate = function (delta, related, axisType) {
        ...
        switch (axisType) {
            case 0:
                transMetrix = translate.apply(void 0, Util.VecMat4(mat4(-1), this.basePosition));
    ...
    ButterFly.prototype.zoom = function (size, related) {
        var transMetrix = translate.apply(void 0, Util.VecMat4(mat4(-1), this.basePosition));
        var temp = mat4(size);
        temp[3][3] = 1;
        transMetrix = mult(temp, transMetrix);
        transMetrix = mult(translate.apply(void 0, this.basePosition), transMetrix);
...
var Util = /** @class */ (function () {
    ...
    Util.VecMat4 = function (Mat4, Vec) {
        var tempVec = [];
        for (var i in [0, 1, 2]) {
